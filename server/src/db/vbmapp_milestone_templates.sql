...
CREATE TABLE IF NOT EXISTS vbmapp_milestone_templates (
  ...
  template_origin            VARCHAR(40) NOT NULL DEFAULT 'manual_override'
);

-- Seed targeted manual milestone overrides.
-- All remaining official milestones are generated by syncVbmappMilestoneTemplates.js.
