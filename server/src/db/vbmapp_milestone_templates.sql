...
('LR-14', 'Listener Responding',
 'Record each trial as independent, prompted, error, or no response. Note whether the direction was 2-step or 3-step, what prompt level was needed, and whether the learner completed the full sequence in order. Include a mix of tabletop and natural-environment probes once the skill is emerging.',
 'Learner attends to spoken instructions, follows 1-step directions, receptively identifies common actions and objects, tolerates brief teaching trials, and can respond to prompts or imitation when needed. The learner should already have basic action, object, and simple listener repertoires before moving to 2-step and 3-step directions.',
 'Common classroom or therapy-room items such as a cup, spoon, pencil, book, ball, chair, table, and toys. Use a quiet teaching area with limited distractions at first, plus a data sheet and strong reinforcers ready. Arrange materials so the learner can reach them easily during trials.',
 '"Touch your nose and clap," "Pick up the ball and give it to me," "Stand up and turn around," "Pick up the cup, put it on the table, and sit down," or "Get the book, bring it here, and put it on the chair." Give the direction once in a clear natural voice after confirming the learner is attending.',
 'Learner completes all steps of the spoken direction, in the correct order when order matters, within a reasonable amount of time and without extra help for an independent score.',
 'Learner completes only part of the direction, performs the wrong action, completes steps out of order when order matters, needs help after the SD, does not respond within about 3 to 5 seconds, or engages in unrelated behavior.',
 'least_to_most',
 'Start with an independent opportunity, then move to gestural prompt, model prompt, partial physical prompt, and full physical prompt only as needed. Use the least intrusive prompt necessary, fade quickly, avoid repeated verbal SDs, and do not over-prompt.',
 'If the learner responds incorrectly or does not respond, give a brief neutral statement such as "Try again," re-present the SD, immediately prompt the correct full response, and reinforce the prompted success at a lower level than an independent response. Run a new trial soon after and keep the correction brief and neutral.',
 'After a prompted success, transfer back to independence by re-presenting the same or a very similar direction and giving the learner another chance to respond without help. Move from prompted responding to independent responding as quickly as possible while keeping success high.',
 'Use strong reinforcement for independent correct responses, such as behavior-specific praise plus a preferred item or activity. Reinforce prompted correct responses more lightly, start with dense reinforcement during acquisition, and thin reinforcement gradually as independence improves.',
 'Practice across different instructors, rooms, times of day, materials, and combinations of 2-step and 3-step directions. Include gross motor directions, object directions, classroom directions, and natural daily routines in both structured teaching and natural opportunities.',
 'Continue to practice mastered directions regularly, mix mastered directions with new ones, and probe across people and settings. Gradually reduce direct teaching as the learner remains successful, and embed maintenance targets in cleanup, snack, transitions, and group activities with weekly probes at first and then biweekly or monthly as appropriate.')
