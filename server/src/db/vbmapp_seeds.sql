...
-- LISTENER RESPONDING
-- ============================================================
('Listener Responding', 1, 1,  'LR-1',  'Attends to a speaker''s voice by making eye contact with the speaker 5 times. (TO: 30 min.)'),
('Listener Responding', 1, 2,  'LR-2',  'Responds to hearing his own name 5 times (e.g., looks at the speaker). (T)'),
('Listener Responding', 1, 3,  'LR-3',  'Looks at, touches, or points to the correct family member, pet, or other reinforcer when presented in an array of 2, for 5 different reinforcers (e.g., Where''s Elmo? Where''s mommy?). (E)'),
('Listener Responding', 1, 4,  'LR-4',  'Performs 4 different motor actions on command without a visual prompt (e.g., Can you jump? Show me clapping). (T)'),
('Listener Responding', 1, 5,  'LR-5',  'Selects the correct item from an array of 4, for 20 different objects or pictures (e.g., Show me cat. Touch shoe). (T)'),
('Listener Responding', 2, 6,  'LR-6',  'Selects the correct item from a messy array of 6, for 40 different objects or pictures (e.g., Find cat. Touch ball.). (T)'),
('Listener Responding', 2, 7,  'LR-7',  'Generalizes listener discriminations (LDs) in a messy array of 8, for 3 different examples of 50 items (e.g., the child can find 3 examples of a train). (T)'),
('Listener Responding', 2, 8,  'LR-8',  'Performs 10 specific motor actions on command (e.g., Show me clapping. Can you hop?). (T)'),
('Listener Responding', 2, 9,  'LR-9',  'Follows 50 two-component noun-verb and/or verb-noun instructions (e.g., Show me the baby sleeping. Push the swing.). (T)'),
('Listener Responding', 2, 10, 'LR-10', 'Selects the correct item in a book, picture scene, or natural environment when named, for 250 items (tested or from an accumulated list of known words). (T)'),
('Listener Responding', 3, 11, 'LR-11', 'Selects items by color and shape from an array of 6 similar stimuli, for 4 colors and 4 shapes (e.g., Find the red car. Find the square cracker.). (T)'),
('Listener Responding', 3, 12, 'LR-12', 'Follows instructions involving 6 different prepositions (e.g., Stand behind the chair.) and 4 different pronouns (e.g., Touch my ear.). (T)'),
('Listener Responding', 3, 13, 'LR-13', 'Selects items from an array of similar stimuli based on 4 pairs of relative adjectives (e.g., big-little, long-short) and demonstrates actions based on 4 pairs of relative adverbs (e.g., quiet-loud, fast-slow). (T)'),
('Listener Responding', 3, 14, 'LR-14', 'Follows 3-step directions for 10 different directions (e.g., Get your coat, hang it up, and sit down.). (T)'),
('Listener Responding', 3, 15, 'LR-15', 'Has a total listener repertoire of 1200 words (nouns, verbs, adjectives, etc.) or from an accumulated list of known words. (T)'),
...
-- INDEPENDENT PLAY
-- ============================================================
('Independent Play', 1, 1,  'IP-1',  'Manipulates and explores objects for 1 minute (e.g., looks at a toy, turns it over, presses buttons). (TO: 30 min.)'),
('Independent Play', 1, 2,  'IP-2',  'Shows variation in play by independently interacting with 5 different items (e.g., plays with rings, then a ball, then a block). (TO: 30 min.)'),
('Independent Play', 1, 3,  'IP-3',  'Demonstrates generalization by engaging in exploratory movement and playing with the items in a novel environment for 2 minutes (e.g., in a new playroom). (TO: 30 min.)'),
('Independent Play', 1, 4,  'IP-4',  'Independently engages in movement play for 2 minutes (e.g., running, dancing, rocking, jumping, climbing). (TO: 30 min.)'),
('Independent Play', 1, 5,  'IP-5',  'Independently engages in cause-and-effect play for 2 minutes (e.g., items in containers, playing with pop-up toys, pulling toys). (TO: 30 min.)'),
('Independent Play', 2, 6,  'IP-6',  'Searches for a missing or corresponding toy or part of a set for 5 items or sets (e.g., a puzzle piece, a ball for a drop-in toy, a bottle for a baby doll). (E)'),
('Independent Play', 2, 7,  'IP-7',  'Independently demonstrates the use of toys or objects according to their function for 5 items (e.g., placing a train on a track, pulling a wagon, holding a telephone to the ear). (O)'),
('Independent Play', 2, 8,  'IP-8',  'Plays with everyday items in creative ways 2 times (e.g., uses a bowl as a drum or a box as an imaginary car). (O)'),
('Independent Play', 2, 9,  'IP-9',  'Independently engages in play on structures and playground equipment for a total of 5 minutes (e.g., going down a slide, swinging). (TO: 30 min.)'),
('Independent Play', 2, 10, 'IP-10', 'Assembles toys that have multiple parts for 5 different sets of materials (e.g., Mr. Potato Head, Little People sets, Cooties bugs, Kid K''Nex). (O)'),
('Independent Play', 3, 11, 'IP-11', 'Spontaneously engages in pretend or imaginary play on 5 occasions (e.g., dressing up, a pretend party with stuffed animals, pretends to cook). (O)'),
('Independent Play', 3, 12, 'IP-12', 'Repeats a gross motor play behavior to obtain a better effect for 2 activities (e.g., throwing a ball in a basket, swinging a bat at a T-ball, foot stomping to launch a rocket, pumping a swing). (O)'),
('Independent Play', 3, 13, 'IP-13', 'Independently engages in arts and crafts type activities for 5 minutes (e.g., drawing, coloring, painting, cutting, pasting). (O)'),
('Independent Play', 3, 14, 'IP-14', 'Independently engages in sustained play activities for 10 minutes without adult prompts or reinforcement (e.g., playing with an Etch-A-Sketch, playing dress-up). (O)'),
('Independent Play', 3, 15, 'IP-15', 'Independently draws or writes in pre-academic activity books for 5 minutes (e.g., dot-to-dot, matching games, mazes, tracing letters and numbers). (O)'),
